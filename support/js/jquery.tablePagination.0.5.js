 ...
 */
//alert('"'+CI.base_url+'images/first.gif"');
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			...
			rowsPerPage : 5,
			currPage : 1,
			optionsForRows : [5,7,10,25,50,100],
			ignoreRows : [],
			topNav : false
		};  
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<span id='tablePagination_perPage' style='font-size:11px;'>");
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' style='font-size:11px;'><option value='5'>5</option></select>");
        htmlBuffer.push(" Per Page");
        htmlBuffer.push("</span>");
        htmlBuffer.push("<span id='tablePagination_paginater' style='font-size:11px;  '>");
        ...
        htmlBuffer.push("<span id='tablePagination_currPage'>&nbsp;Page&nbsp;"+currPageNumber+"</span>");
        //htmlBuffer.push("<input id='tablePagination_currPage' type='input' size='1' value='"+currPageNumber+"' style=' text-align:center;font-size:11px;' />");
